...
@section('header')
<span class="titleBox">Generar planilla PDF</span>
...
<div class='clearfix col-sm-12 col-md-12'>
	<span class="form-inline">
		...
		<input id="fecha-mes" name="fecha-mes" type="month" class="form-control" required>
	</span>
</div>
<hr>
<div class="cont-form-material">
	<div class="form-material">	
		...
		<div class="bt-s-c">
			<button type="submit" id="btn_submit"><i class="glyphicon glyphicon-remove"></i> Cancelar</button>
			<a href="{{ url ('/export-PDF') }}"><i class="fa fa-file-pdf-o"></i> Generar</a>
		</div>
	</div>
</div>
{!! Form::close() !!}
...
@section('scripts')
<script src="{{ asset('js/formRes.js') }}" type="text/javascript" charset="utf-8"></script>
<script>
	$(function() {
