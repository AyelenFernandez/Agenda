				...
				<div class="form-group">
					...
					<div class="row" id="campos-fecha-1">
						<div class="col-xs-9 col-sm-10 col-md-10">
							...
							<input class='dtfecha form-control' placeholder='Fecha del Evento' required='required' name='fecha[]' type='text' id='fecha1' value="{!!$datos['fecha']!!}">

							{{-- {!! Form::text('fecha', null, ['class' => 'dtfecha form-control', 'placeholder' => 'Fecha del Evento', 'required']) !!} --}}
						</div>
